...
public class FileUploadController {
    ...
    public Result<Map<String, Object>> uploadViolationPhotos(
        ...
        log.info("开始上传违规照片, 文件名: {}, 大小: {} KB, userId: {}", 
                file.getOriginalFilename(), 
                file.getSize() / 1024, 
                userId);
        
        Result<Map<String, Object>> result = uploadFile(file, "violation-photos", request);
        
        long endTime = System.currentTimeMillis();
        log.info("完成上传, 耗时: {} ms, 结果: {}", 
                (endTime - startTime), 
                "0".equals(result.getCode()) ? "成功" : "失败");
    ...
    public Result<Map<String, Object>> uploadAvatars(
        ...
        long startTime = System.currentTimeMillis();
        log.info("开始上传头像, 文件名: {}, 大小: {} KB", 
                file.getOriginalFilename(), 
                file.getSize() / 1024);
        
        Result<Map<String, Object>> result = uploadFile(file, "avatars", request);
